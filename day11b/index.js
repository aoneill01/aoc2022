...
const relief = monkeys
  .map((monkey) => monkey.testDivisible)
  .reduce((acc, num) => acc * num);
for (let i = 0; i < 10000; i++) {
  for (const id in monkeys) {
    processMonkey(monkeys, id, relief);
  }
}
